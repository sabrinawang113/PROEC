********************************************************************************
*	Do-file:		4_2AN_clogit_ectype1.do
...
capture log close 
cd "$PROEClog"
log using "4_2AN_clogit_ectype1$current_date", replace
set linesize 255
...
// keep only type 1 endometrial cancer
/*
TYPE I tumour
...
8441/3  Serous cystadenocarcinoma, NOS (C56.9)     
