********************************************************************************
*	Do-file:		4_5AN_clogit_2yrbaseline.do
...
capture log close 
cd "$PROEClog"
log using "4_5AN_clogit_2yrbaseline$current_date", replace
set linesize 255
...
global dataset = "PROEC_2yrfrombaseline"
cd "$PROECderived"
...
syntax, file(string) covar(string)
	...
	* compute qvalue	
	...
	qqvalue pval , method(holland) qvalue(qvalue) npvalue(npvalue)
	sort qvalue
