...
capture log close 
cd "$PROEClog"
log using "6CR_olink_lod$current_date", replace
set linesize 255
...
// Exclude proteins with >75% below LOD (i.e. <25% above lod)
...
foreach outdp in $outdpflag {
	local protein = substr("`outdp'",7,.) 
	di "`protein'"
	estpost tab `outdp'
	matrix pct = e(pct)
	matrix list pct
	cap drop pabovelod
	gen pabovelod = pct[1,1]
	if pabovelod<25 {
	drop `protein'
	}
	if `outdp'==1 & pct[1,1]==100 {
	drop `protein'
	}
}
...
cd "$PROECderived"
save PROEC_coredata_olk75, replace

********************************************************************************

// Cr a dataset with only 50-75% below LOD proteins

cd "$PROECderived"
use PROEC_coredata_olk75, clear
* Exclude proteins with <=50% below LOD (i.e. >50% above lod) from this dataset
...
keep *_ir
global ires = ///
"olk_ppp1r9b_ir olk_glb1_ir olk_psip1_ir olk_zbtb16_ir olk_tpsab1_ir olk_hcls1_ir olk_cntnap2_ir olk_clec4g_ir olk_irf9_ir olk_edar_ir olk_il6_ir olk_clec4c_ir olk_irak1_ir olk_clec4a_ir olk_prdx1_ir olk_prdx3_ir olk_fgf2_ir olk_prdx5_ir olk_dpp10_ir olk_trim5_ir olk_dctn1_ir olk_itga6_ir olk_cdsn_ir olk_traf2_ir olk_trim21_ir olk_lilrb4_ir olk_ntf4_ir olk_krt19_ir olk_itm2a_ir olk_hnmt_ir olk_ccl11_ir olk_milr1_ir olk_egln1_ir olk_nfatc3_ir olk_ly75_ir olk_eif4g1_ir olk_cd28_ir olk_pth1r_ir olk_hsd11b1_ir olk_plxna4_ir olk_sh2b3_ir olk_fcrl3_ir olk_ckap4_ir olk_jun_ir olk_hexim1_ir olk_clec4d_ir olk_prkcq_ir olk_mgmt_ir olk_cxadr_ir olk_il10_ir olk_srpk2_ir olk_klrd1_ir olk_bach1_ir olk_pik3ap1_ir olk_spry2_ir olk_stc1_ir olk_fam3b_ir olk_sh2d1a_ir olk_dffa_ir olk_dcbld2_ir olk_fcrl6_ir olk_ncr1_ir olk_areg_ir olk_ifnlr1_ir olk_dapp1_ir olk_sit1_ir olk_masp1_ir olk_lamp3_ir olk_clec7a_ir olk_clec6a_ir olk_ddx58_ir olk_il12rb1_ir olk_itga11_ir olk_kpna1_ir olk_lag3_ir olk_il5_ir olk_cd83_ir olk_itgb6_ir olk_btn3a2_ir"
restore
...
foreach protein in $olk { 
	estpost tab outdq_`protein'
	matrix pct = e(pct)
	matrix list pct
	cap drop pabovelod
	gen pabovelod = pct[1,1]
...
* save separate dataset
cd "$PROECderived"
save PROEC_coredata_olk5075, replace

********************************************************************************

// Cr a dataset with only <=50% below LOD proteins
...
* save separate dataset
cd "$PROECderived"
save PROEC_coredata_olk50, replace
